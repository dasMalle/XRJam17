...
[CustomEditor(typeof(TerrainWithLayersFactory))]
public class TerrainWithLayersFactoryEditor : FactoryEditor
{
	private string _defaultMapId = "mapbox.terrain-rgb";
	private TerrainWithLayersFactory _factory;
	...
	void OnEnable()
	{
		_factory = target as TerrainWithLayersFactory;
		...
		script = MonoScript.FromScriptableObject((TerrainWithLayersFactory)target);
	}
